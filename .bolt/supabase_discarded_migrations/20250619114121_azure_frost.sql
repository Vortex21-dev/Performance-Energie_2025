...
CREATE INDEX IF NOT EXISTS idx_enjeux_internes_externes_org ON enjeux_internes_externes(organization_name);
CREATE INDEX IF NOT EXISTS idx_enjeux_internes_externes_type ON enjeux_internes_externes(type);
