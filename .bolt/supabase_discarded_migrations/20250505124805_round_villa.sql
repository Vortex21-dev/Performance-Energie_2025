/*
  # Create sector_standards table and standards table
  
  1. New Tables
    - `standards`: Stores available standards
    - `sector_standards`: Junction table linking sectors to standards
  
  2. Changes
    - Create standards table with name as primary key
    - Create sector_standards table with composite key
